...
public class Main {
    ...
    public static void main(String[] args){
       ...
       harryPotter.studentСomparisonGryffindor(hermioneGranger);
        harryPotter.studentСomparisonGryffindor(ronaldWeasley);
        ronaldWeasley.studentСomparisonGryffindor(hermioneGranger);
        System.out.println(" ");
        System.out.println("Hufflepuff");

       zachariasSmith.studentСomparisonHufflepuff(cedricDiggory);
       cedricDiggory.studentСomparisonHufflepuff(justinFinchFletchley);
        justinFinchFletchley.studentСomparisonHufflepuff(zachariasSmith);
        System.out.println(" ");
        System.out.println("Ravenclaw");

       choChang.studentСomparisonRavenclaw(padmaPatil);
        padmaPatil.studentСomparisonRavenclaw(marcusBelby);
        marcusBelby.studentСomparisonRavenclaw(choChang);
        System.out.println(" ");
        System.out.println("Slytherin");

       dracoMalfoy.studentСomparisonSlytherin(grahamMontague);
       grahamMontague.studentСomparisonSlytherin(gregoryGoyle);
        gregoryGoyle.studentСomparisonSlytherin(dracoMalfoy);
